<template>
  <div class="middle-container">
    ...
    <div class="layout-container">
      ...
      <!-- <select-radio v-bind:content="content"
      @showApplyModal="showApply"
      @previewImg="showImg"
       /> -->
      <!-- <select-checkbox v-bind:content="content2"/>
      <describe-topic v-bind:content="content3"/>
      <fill-blank v-bind:content="content4"/> -->
    </div>
    <el-dialog
      title="试题报错"
...
import SelectCheckbox from '../../../components/global/select-checkbox/select-checkbox'
import DescribeTopic from '../../../components/global/describe-topic/describe-topic'
import FillBlank from '../../../components/global/fill-blank/fill-blank'
